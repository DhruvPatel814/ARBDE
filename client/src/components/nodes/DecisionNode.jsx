...
export default function DecisionNode({ data, id }) {
  ...
  let borderClass = 'border-green-200 hover:border-green-400';
  ...
  return (
    <div 
      title="Performs conditional branching"
      className={`bg-white border rounded-xl shadow-sm w-64 group hover:shadow-md transition-all flex flex-col pt-1 ${borderClass} ${opacityClass}`}
    >
